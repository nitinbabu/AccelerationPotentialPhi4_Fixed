function [SysA,b,MatA,MatB,Ivec,Jmid]=SysEquationsMF(x,y,nnode,nelem,qnode,knvec,ktvec,corner4,uL)
%%
% corner4 = [C1 C2 C3 C4];
%% Made faster by filling MatA in the same loop. Simple fix 08/01/23
%% Almost as fast as default HOBEM
C1 = corner4(1); C2 = corner4(2); C3 = corner4(3); C4 = corner4(4);
...
Mvec = 1:nelem; Qmid = zeros(size(Mvec)); Jmid = zeros(length(nelem));
count = 1;
for j = 1:nnode
